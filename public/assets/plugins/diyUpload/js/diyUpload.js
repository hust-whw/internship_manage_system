	...
	$.fn.extend({
		...
		*/
		diyUpload:function( opt, serverCallBack ) {
			...
			if(teacherID==""||projectName.toString()=="")
			{
				alert("请输入教师ID和项目名称！");
				return false;
			}
			...
			webUploader.options.formData.teacherID = teacherID;
			webUploader.options.formData.projectName = projectName;
			webUploader.options.formData.text = text;
